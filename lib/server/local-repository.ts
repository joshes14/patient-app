...
export {
  getAppSettings as localGetAppSettings,
  updateAppSettings as localUpdateAppSettings,
  listPractitioners as localListPractitioners,
  createPractitioner as localCreatePractitioner,
  updatePractitionerPassword as localUpdatePractitionerPassword,
  deactivatePractitioner as localDeactivatePractitioner,
  listPatients as localListPatients,
  getPatientById as localGetPatientById,
  createPatient as localCreatePatient,
  updatePatient as localUpdatePatient,
  updatePatientReviewStatus as localUpdatePatientReviewStatus,
  deletePatient as localDeletePatient,
  getMedicalHistory as localGetMedicalHistory,
  upsertMedicalHistory as localUpsertMedicalHistory,
  getDentalHistory as localGetDentalHistory,
  upsertDentalHistory as localUpsertDentalHistory,
  getLatestIntraoralExam as localGetLatestIntraoralExam,
  upsertIntraoralExam as localUpsertIntraoralExam,
